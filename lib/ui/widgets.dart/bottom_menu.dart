       ...
       Container(
             ...
             children: <Widget>[
               GestureDetector(
                 onTap: (){
                   ...
                   child: fireSvgwidthColor(screenW(0.1, context), 'label', 'assets/menu0.svg',Colors.black),
                 ),
               ),
                GestureDetector(
                 onTap: (){
                    if (Cookie.of(context).menuPosition!="1") {
                      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>Search()), 
                                         (Route<dynamic> route) => false
                                         );
                    ...
                    Cookie.of(context).setMenuPosition("1");
                                ...
                                child: Container(
                   padding: EdgeInsets.all(screenH(0.017, context)) ,
                   child: fireSvgwidthColor(screenW(0.1, context), 'label', 'assets/menu1.svg',Colors.black),
                 ),
               ),
               Container(width: screenW(0.15, context),),
               GestureDetector(
                 onTap: (){
                    if (Cookie.of(context).menuPosition!="3") {
                   Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>OrderHistory()), 
                                         (Route<dynamic> route) => false
                                         );
                    ...
                    Cookie.of(context).setMenuPosition("3");
                     ...
                     child: fireSvgwidthColor(screenW(0.1, context), 'label', 'assets/menu3.svg',Colors.black),
                   ),
               ),
               ...
               GestureDetector(
                   ...
                   child: fireSvgwidthColor(screenW(0.1, context), 'label', 'assets/menu4.svg',Colors.black),
                 ),
               ),
             ],
           ),
        ...
        Align(
          ...
          child: Badge(
            ...
            badgeContent: Text(Cookie.of(context).orderNumber.toString(),style: TextStyle(color: Colors.white),),
            ...
            child: Container(
              ...
              GestureDetector(
                   onTap: (){
                    ...
                    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>Basket()), 
                                          (Route<dynamic> route) => false
                                          );
                     Cookie.of(context).setMenuPosition("2");
                   }
                   },
              child: fireSvgwidth(screenW(0.1, context), 'label', 'assets/menu2.svg')),
